...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{asset('style/assets/modules/bootstrap-social/bootstrap-social.css')}}">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{asset('storage/img/sysmex.png')}}"  alt="logo" width="250" class="shadow-light">
            </div>
            ...
            <div class="simple-footer">
              Copyright &copy;  SysmexIndonesia 2020
            </div>
          </div>
        </div>
      </div>
